...
public class StoreHome extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inventory.add(new InventoryItem("Laser Pointer", "Points lasers",
                "laser", 34.99, R.drawable.laser_pointer));
        inventory.add(new InventoryItem("Booby Trap", "Fools henchmen", "traps",
                109.95, R.drawable.booby_trap));
        inventory.add(new InventoryItem("Laser Pointer", "Points lasers",
                "laser", 34.99, R.drawable.laser_pointer));
        inventory.add(new InventoryItem("Booby Trap", "Fools henchmen", "traps",
                109.95, R.drawable.booby_trap));
...
//Instantiates the viewflipper from content_store_home and sets animations for switching views
        ...
        flipper.setInAnimation(this, R.anim.view_flip_in);
        flipper.setOutAnimation(this, R.anim.view_flip_out);
...
//Instantiates RecyclerView and sets a horizontal layout managaer
        ...
        RecyclerView categoryRecycler5 = (RecyclerView) findViewById(R.id.homeRecycler_5);
        ...
        categoryRecycler5.setLayoutManager(layoutManager5);
        ...
        categoryRecycler5.setAdapter(cardRecyclerAdapter);
